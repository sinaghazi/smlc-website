        ...
        <div className="bg-white py-24 sm:py-32" id="explore">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    <h2 className="text-base font-barlowSemi uppercase leading-7 text-kokoomus-blue">
                        Comprehensive Framework
                    </h2>
                    <p className="mt-2 text-3xl font-barlow italic uppercase font-bold tracking-tight text-kokoomus-navy sm:text-4xl">
                ...
                <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                    <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                        {features.map((feature) => (
                            <div key={feature.name} className="flex flex-col">
                                <dt className="flex items-center gap-x-3 text-base font-barlowSemi leading-7 text-kokoomus-navy">
                                    <feature.icon className="h-5 w-5 flex-none text-kokoomus-blue" aria-hidden="true" />
                                    {feature.name}
                                </dt>
                                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 font-sourceSerif text-gray-600">
                    ...
                    <div className="mt-16 flex justify-center">
                        <a
                            href="#interactive"
                            className="inline-flex items-center gap-x-2 rounded-md bg-kokoomus-blue px-3.5 py-2.5 text-sm font-barlowSemi uppercase text-white shadow-sm hover:bg-kokoomus-navy focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-kokoomus-blue"
                        >
